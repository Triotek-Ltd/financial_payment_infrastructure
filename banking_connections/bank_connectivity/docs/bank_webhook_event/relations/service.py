"""Relation service seed for bank_webhook_event."""
...
RELATED_DOCS = [{'doc_id': 'bank_connection', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'bank_transfer_request', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'settlement_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'provider/account identity from bank_connection'}]
