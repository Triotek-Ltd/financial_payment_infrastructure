"""Business-domain service seed for Bank Webhook Event."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'normalized_status': 'status_flag', 'related_bank_connection': 'relation_collection', 'related_bank_transfer_request': 'relation_collection', 'related_settlement_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'event_code', 'event_type', 'source_connection'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'received', 'lifecycle_states': ['received', 'normalized', 'linked', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'normalize': None, 'link': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['bank_connection', 'bank_transfer_request', 'settlement_record'], 'action_targets': {'record': None, 'normalize': None, 'link': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
