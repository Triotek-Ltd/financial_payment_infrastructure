"""Relation service seed for bank_connection."""
...
RELATED_DOCS = [{'doc_id': 'settlement_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'bank_transfer_request', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'bank_webhook_event', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cash_account', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'institution/account context from finance cash-account setup where linked'}]
