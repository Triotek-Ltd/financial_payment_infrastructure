"""Business-domain service seed for Bank Connection."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'configuration_control', 'case_management': False}, 'reporting_profile': {'supports_snapshots': False, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': True}, 'lifecycle_states': ['draft', 'verified', 'active', 'disabled', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'active_status': 'status_flag', 'related_settlement_record': 'relation_collection', 'related_bank_transfer_request': 'relation_collection', 'related_bank_webhook_event': 'relation_collection', 'related_cash_account': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'connection_code', 'institution_identity', 'account_or_channel_scope'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'verified', 'active', 'disabled', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['settlement_record', 'bank_transfer_request', 'bank_webhook_event', 'cash_account'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
