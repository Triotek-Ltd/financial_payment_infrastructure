"""Relation service seed for bank_transfer_request."""
...
RELATED_DOCS = [{'doc_id': 'bank_connection', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'settlement_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'supplier_payment', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'treasury_movement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source account'}, {'description': 'institution from bank_connection'}]
