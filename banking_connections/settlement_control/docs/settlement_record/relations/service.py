"""Relation service seed for settlement_record."""
...
RELATED_DOCS = [{'doc_id': 'bank_connection', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'bank_transfer_request', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'treasury_movement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cash_position_snapshot', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
