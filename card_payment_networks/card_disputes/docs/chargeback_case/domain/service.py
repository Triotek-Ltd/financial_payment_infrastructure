"""Business-domain service seed for Chargeback Case."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['opened', 'evidence_requested', 'represented', 'won', 'lost', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'related_card_authorization_record': 'relation_collection', 'related_refund_case': 'relation_collection', 'related_payment_log_entry': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'linked_authorization', 'dispute_reason'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'evidence_requested', 'represented', 'won', 'lost', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': None, 'represent': None, 'accept': None, 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['card_authorization_record', 'refund_case', 'payment_log_entry'], 'action_targets': {'create': None, 'assign': None, 'represent': None, 'accept': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
