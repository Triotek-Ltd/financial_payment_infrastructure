"""Relation service seed for chargeback_case."""
...
RELATED_DOCS = [{'doc_id': 'card_authorization_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'refund_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_log_entry', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'authorization'}, {'description': 'transaction context from card_authorization_record'}]
