"""Relation service seed for terminal_settlement."""
...
RELATED_DOCS = [{'doc_id': 'card_authorization_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'card_network_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'settlement_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'merchant/terminal context from card_network_profile'}]
