"""Business-domain service seed for Terminal Settlement."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'posting_flow', 'supports_reconciliation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['open', 'settled', 'reconciled', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'batch_date': 'schedule_marker', 'batch_total': 'monetary_value', 'settled_total': 'monetary_value', 'related_card_authorization_record': 'relation_collection', 'related_card_network_profile': 'relation_collection', 'related_settlement_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'settlement_code', 'terminal_or_merchant_reference', 'batch_date'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'open', 'lifecycle_states': ['open', 'settled', 'reconciled', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'review': None, 'reconcile': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['card_authorization_record', 'card_network_profile', 'settlement_record'], 'action_targets': {'record': None, 'review': None, 'reconcile': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
