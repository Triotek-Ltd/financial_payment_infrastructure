"""Business-domain service seed for Card Network Profile."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'active_status': 'status_flag', 'related_card_authorization_record': 'relation_collection', 'related_chargeback_case': 'relation_collection', 'related_terminal_settlement': 'relation_collection', 'related_payment_log_entry': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'profile_code', 'network_or_acquirer_identity', 'merchant_scope'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'verified', 'active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['card_authorization_record', 'chargeback_case', 'terminal_settlement', 'payment_log_entry'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
