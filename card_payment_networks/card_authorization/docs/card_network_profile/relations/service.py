"""Relation service seed for card_network_profile."""
...
RELATED_DOCS = [{'doc_id': 'card_authorization_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'chargeback_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'terminal_settlement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_log_entry', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'merchant context from commerce/payment config where linked'}]
