"""Action handler seed for card_authorization_record:reverse."""
...
ACTION_ID = "reverse"
ACTION_RULE = {'allowed_in_states': ['initiated', 'authorized', 'captured', 'failed', 'settled'], 'transitions_to': 'reversed'}
