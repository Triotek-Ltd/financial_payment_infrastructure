"""Relation service seed for card_authorization_record."""
...
RELATED_DOCS = [{'doc_id': 'card_network_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'chargeback_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'terminal_settlement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_attempt', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'merchant'}, {'description': 'processor context from card_network_profile'}, {'description': 'checkout/payment context from payment_attempt'}]
