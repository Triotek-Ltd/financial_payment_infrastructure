"""Action handler seed for mobile_money_transaction:reverse."""
...
ACTION_ID = "reverse"
ACTION_RULE = {'allowed_in_states': ['initiated', 'pending', 'successful', 'failed', 'settled'], 'transitions_to': 'reversed'}
