"""Business-domain service seed for Mobile Money Transaction."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['initiated', 'pending', 'successful', 'failed', 'settled', 'reversed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'provider_status': 'status_flag', 'related_wallet_provider_profile': 'relation_collection', 'related_wallet_reversal_case': 'relation_collection', 'related_wallet_settlement': 'relation_collection', 'related_payment_attempt': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'transaction_code', 'customer_or_wallet_reference', 'amount'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'initiated', 'lifecycle_states': ['initiated', 'pending', 'successful', 'failed', 'settled', 'reversed', 'archived'], 'terminal_states': ['reversed', 'archived'], 'action_targets': {'create': None, 'submit': None, 'confirm': None, 'reverse': 'reversed', 'settle': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['wallet_provider_profile', 'wallet_reversal_case', 'wallet_settlement', 'payment_attempt'], 'action_targets': {'create': None, 'submit': None, 'confirm': None, 'reverse': 'reversed', 'settle': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
