"""Relation service seed for wallet_provider_profile."""
...
RELATED_DOCS = [{'doc_id': 'mobile_money_transaction', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'wallet_reversal_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'wallet_settlement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'merchant/account context from finance/integration setup where linked'}]
