"""Business-domain service seed for Wallet Reversal Case."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['opened', 'investigating', 'reversed', 'rejected', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'related_mobile_money_transaction': 'relation_collection', 'related_wallet_settlement': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'case_code', 'source_transaction', 'reason'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'opened', 'lifecycle_states': ['opened', 'investigating', 'reversed', 'rejected', 'closed', 'archived'], 'terminal_states': ['reversed', 'closed', 'archived'], 'action_targets': {'create': None, 'assign': None, 'investigate': None, 'reverse': 'reversed', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['mobile_money_transaction', 'wallet_settlement'], 'action_targets': {'create': None, 'assign': None, 'investigate': None, 'reverse': 'reversed', 'reject': 'rejected', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
