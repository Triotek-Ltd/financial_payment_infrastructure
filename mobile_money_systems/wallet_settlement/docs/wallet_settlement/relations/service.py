"""Relation service seed for wallet_settlement."""
...
RELATED_DOCS = [{'doc_id': 'wallet_provider_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'mobile_money_transaction', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cash_position_snapshot', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'provider identity from wallet_provider_profile'}]
