"""Relation service seed for processor_event_log."""
...
RELATED_DOCS = [{'doc_id': 'processor_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_intent_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'processor_payout', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'provider/account identity from processor_account'}]
