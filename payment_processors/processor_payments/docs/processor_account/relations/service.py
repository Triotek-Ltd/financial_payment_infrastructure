"""Relation service seed for processor_account."""
...
RELATED_DOCS = [{'doc_id': 'payment_intent_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'processor_payout', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'processor_event_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_attempt', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'merchant/program context from commerce/payment setup'}]
