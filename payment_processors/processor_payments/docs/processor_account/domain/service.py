"""Business-domain service seed for Processor Account."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'configuration_control', 'case_management': False}, 'reporting_profile': {'supports_snapshots': False, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': True}, 'lifecycle_states': ['draft', 'verified', 'active', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'active_status': 'status_flag', 'related_payment_intent_record': 'relation_collection', 'related_processor_payout': 'relation_collection', 'related_processor_event_log': 'relation_collection', 'related_payment_attempt': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'account_code', 'processor_identity', 'merchant_identifier'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'verified', 'active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['payment_intent_record', 'processor_payout', 'processor_event_log', 'payment_attempt'], 'action_targets': {'create': None, 'verify': None, 'activate': 'active', 'disable': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
