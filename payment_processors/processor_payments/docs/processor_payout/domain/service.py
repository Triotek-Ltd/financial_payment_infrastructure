...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'payout_date': 'schedule_marker', 'payout_amount': 'monetary_value', 'fee_total': 'monetary_value'}, 'search_fields': ['title', 'reference_no', 'description', 'payout_code', 'payout_date', 'processor_account'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'pending', 'lifecycle_states': ['pending', 'in_transit', 'paid', 'failed', 'reconciled', 'archived'], 'terminal_states': ['paid', 'archived'], 'action_targets': {'create': None, 'review': None, 'confirm_arrival': None, 'reconcile': None, 'archive': 'archived'}}
