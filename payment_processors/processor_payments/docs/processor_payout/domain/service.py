"""Business-domain service seed for Processor Payout."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['pending', 'in_transit', 'paid', 'failed', 'reconciled', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'payout_date': 'schedule_marker', 'payout_amount': 'monetary_value', 'fee_total': 'monetary_value', 'related_payment_intent_record': 'relation_collection', 'related_settlement_record': 'relation_collection', 'related_cash_position_snapshot': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'payout_code', 'payout_date', 'processor_account'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'pending', 'lifecycle_states': ['pending', 'in_transit', 'paid', 'failed', 'reconciled', 'archived'], 'terminal_states': ['paid', 'archived'], 'action_targets': {'create': None, 'review': None, 'confirm_arrival': None, 'reconcile': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['processor_account', 'payment_intent_record', 'settlement_record', 'cash_position_snapshot'], 'action_targets': {'create': None, 'review': None, 'confirm_arrival': None, 'reconcile': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
