"""Relation service seed for processor_payout."""
...
RELATED_DOCS = [{'doc_id': 'processor_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_intent_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'settlement_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'cash_position_snapshot', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'processor identity from processor_account'}]
