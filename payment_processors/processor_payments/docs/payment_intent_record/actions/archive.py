"""Action handler seed for payment_intent_record:archive."""
...
ACTION_ID = "archive"
ACTION_RULE = {'allowed_in_states': ['created', 'requires_action', 'processing', 'succeeded', 'failed', 'cancelled'], 'transitions_to': 'archived'}
