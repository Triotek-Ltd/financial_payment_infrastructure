"""Relation service seed for payment_intent_record."""
...
RELATED_DOCS = [{'doc_id': 'processor_account', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'processor_event_log', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'processor_payout', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payment_attempt', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'account context from processor_account'}, {'description': 'checkout/payment context from payment_attempt'}]
